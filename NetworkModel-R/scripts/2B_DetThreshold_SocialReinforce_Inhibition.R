...
ThreshSD       <- ThreshM * 0.01 #population threshold standard deviations !!Change!!
...
c              <- 0.05 #social reinforcer of threshold learning
d              <- 0.05 #social preventer of threshold forgetting
