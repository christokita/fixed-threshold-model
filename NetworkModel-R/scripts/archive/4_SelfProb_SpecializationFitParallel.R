...
gammas         <- c(0, 0.0025, 0.004, 0.005, 0.006, 0.008, seq(0.01, 0.05, 0.005)) #bias towards learning of task !!Change!!
lowerThresh    <- 0
upperThresh    <- 100
...
iteration <- 100 / (length(threshSlopes) * length(gammas) * length(Ns))
