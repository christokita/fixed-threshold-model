...
corrStep       <- 100 #number of time steps for calculation of correlation !!Change!!
...
c              <- 2 #social reinforcer of threshold learning
d              <- 2 #social preventer of threshold forgetting
