...
Averaging      <- TRUE #should social interactions be done in absolute or averaged terms?
lowerThresh    <- 0
upperThresh    <- 100

# Social Network Parameters
p              <- 0.3 #probability of interacting with other individuals
q              <- 3 #probability of interacting with individual in same state relative to others
