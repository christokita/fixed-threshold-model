...
phi            <- 0.001 #learning/forgetting of threshold
gamma          <- 0.001 #bias towards learning of task
c              <- 1 #social reinforcer of threshold learning
d              <- 1 #social preventer of threshold forgetting
